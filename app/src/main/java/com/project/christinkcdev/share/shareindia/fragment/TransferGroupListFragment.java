...
import com.project.christinkcdev.share.shareindia.activity.ContentSharingActivity;
 ...
 * Use the {@link TransferGroupListFragment} factory method to
...
public class TransferGroupListFragment  extends GroupEditableListFragment<TransferGroupListAdapter.PreloadedGroup, GroupEditableListAdapter.GroupViewHolder, TransferGroupListAdapter> implements IconSupport, TitleSupport {
    ...
    {
        View adaptedView = getLayoutInflater().inflate(R.layout.fragment_transfer_group_list, null, false);
