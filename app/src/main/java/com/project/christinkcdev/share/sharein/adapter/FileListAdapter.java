...
import com.project.christinkcdev.share.sharein.util.MimeIconUtils;
...
public class FileListAdapter  extends GroupEditableListAdapter<FileListAdapter.GenericFileHolder, GroupEditableListAdapter.GroupViewHolder>
    ...
    protected void onLoad(GroupLister<GenericFileHolder> lister)
    {
        ...
        if (path != null) {
            ...
            lister.offerObliged(this, new DirectoryHolder(defaultFolder, getContext().getString(R.string.text_receivedFiles), R.drawable.ic_share_in_24));
