...
import static com.project.christinkcdev.share.sharein.activity.MainActivity.REQUEST_PERMISSION_ALL;
...
public class RationalePermissionRequest extends AlertDialog.Builder {
                                      ...
                                      boolean killActivityOtherwise)
    {
        ...
        setPositiveButton(R.string.butn_ask, (dialogInterface, i) -> ActivityCompat.requestPermissions(activity, new String[]{mPermissionQueue.permission}, REQUEST_PERMISSION_ALL));
