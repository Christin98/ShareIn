...
import com.project.christinkcdev.share.shareindia.activity.ConnectionManagerActivity;
...
import com.project.christinkcdev.share.shareindia.dialog.DeviceInfoDialog;
...
import com.project.christinkcdev.share.shareindia.service.DeviceScannerService;
...
import com.project.christinkcdev.share.shareindia.ui.callback.NetworkDeviceSelectedListener;
...
import com.project.christinkcdev.share.shareindia.util.ConnectionUtils;
...
public class NetworkDeviceListFragment extends EditableListFragment<NetworkDeviceListAdapter.EditableNetworkDevice, EditableListAdapter.EditableViewHolder, NetworkDeviceListAdapter> implements TitleSupport, DetachListener, IconSupport, ConnectionManagerActivity.DeviceSelectionSupport {
    ...
    private void openInfo(NetworkDevice device)
    {
        if (device instanceof NetworkDeviceListAdapter.HotspotNetwork) {
            ...
            builder.setMessage(R.string.text_ShareindiaHotspotDescription);
