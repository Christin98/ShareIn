...
import com.project.christinkcdev.share.shareindia.activity.ShareActivity;
...
import com.project.christinkcdev.share.shareindia.app.ShareableListFragment;
...
public class SharingActionModeCallback<T extends Shareable> extends EditableListFragment.SelectionCallback<T> {
    ...
    public boolean onActionMenuItemSelected(Context context, PowerfulActionMode actionMode, MenuItem item)
    {
        ...
        if (selectedItemList.size() > 0
                && (id == R.id.action_mode_share_shareindia || id == R.id.action_mode_share_all_apps)) {
