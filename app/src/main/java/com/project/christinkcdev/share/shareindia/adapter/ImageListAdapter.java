package com.project.christinkcdev.share.shareindia.adapter;
...
import com.project.christinkcdev.share.shareindia.GlideApp;
import com.project.christinkcdev.share.shareindia.R;
import com.project.christinkcdev.share.shareindia.util.TimeUtils;
import com.project.christinkcdev.share.shareindia.widget.GalleryGroupEditableListAdapter;
import com.project.christinkcdev.share.shareindia.widget.GroupEditableListAdapter;

public class ImageListAdapter extends GalleryGroupEditableListAdapter<ImageListAdapter.ImageHolder, GroupEditableListAdapter.GroupViewHolder> {
    ...
    @Override
    protected void onLoad(GroupEditableListAdapter.GroupLister<ImageHolder> lister)
    {
    ...
    public GroupEditableListAdapter.GroupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        if (viewType == VIEW_TYPE_REPRESENTATIVE)
            return new GroupEditableListAdapter.GroupViewHolder(getInflater().inflate(R.layout.layout_list_title, parent, false), R.id.layout_list_title_text);

        return new GroupEditableListAdapter.GroupViewHolder(getInflater().inflate(isGridLayoutRequested()
                ? R.layout.list_image_grid
                : R.layout.list_image, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull GroupEditableListAdapter.GroupViewHolder holder, int position)
    {
        try {
