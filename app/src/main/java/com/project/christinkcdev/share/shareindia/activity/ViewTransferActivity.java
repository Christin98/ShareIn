...
import com.project.christinkcdev.share.shareindia.dialog.EstablishConnectionDialog;
import com.project.christinkcdev.share.shareindia.dialog.SelectAssigneeDialog;
import com.project.christinkcdev.share.shareindia.dialog.ToggleMultipleTransferDialog;
import com.project.christinkcdev.share.shareindia.dialog.TransferInfoDialog;
import com.project.christinkcdev.share.shareindia.fragment.TransferFileExplorerFragment;
...
import com.project.christinkcdev.share.shareindia.util.TextUtils;
...
public class ViewTransferActivity extends Activity implements PowerfulActionModeSupport, SnackbarSupport {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (mGroup == null)
            ...
            mMode.setOnSelectionTaskListener((started, actionMode) -> toolbar.setVisibility(!started ? View.VISIBLE : View.GONE));
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == android.R.id.home) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.butn_remove, (dialog, which) -> getDatabase().removeAsynchronous(ViewTransferActivity.this, mGroup)).show();
