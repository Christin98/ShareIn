...
public class ThirdPartyLibraryListFragment extends DynamicRecyclerViewFragment<ThirdPartyLibraryListFragment.ModuleItem, RecyclerViewAdapter.ViewHolder, ThirdPartyLibraryListFragment.LicencesAdapter> {
    @Override
    public LicencesAdapter onAdapter()
    {
        final AppUtils.QuickActions<RecyclerViewAdapter.ViewHolder> quickActions = clazz -> clazz.getView().findViewById(R.id.menu).setOnClickListener((View.OnClickListener) v -> {
